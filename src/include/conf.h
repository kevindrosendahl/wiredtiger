...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 25, 200);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 25, 201);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 25, 195);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 25, 194);
