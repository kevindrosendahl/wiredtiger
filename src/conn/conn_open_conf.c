...
/*
 * Key mappings for wiredtiger_open_ex. All supported configuration keys.
 */
static const WT_OPEN_CONF_KEY_MAP open_conf_key_map[] = {
  ...
  {WT_OPEN_CONF_generation_drain_timeout_ms, "generation_drain_timeout_ms", NULL,
    WT_OPEN_CONFIG_ARG_INT},
  ...
  {WT_OPEN_CONF_eviction_checkpoint_target, "eviction_checkpoint_target", NULL,
    WT_OPEN_CONFIG_ARG_INT},
  ...
  {WT_OPEN_CONF_compile_configuration_count, "compile_configuration_count", NULL,
    WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_direct_io, "direct_io", NULL, WT_OPEN_CONFIG_ARG_STR},
  {WT_OPEN_CONF_disaggregated_checkpoint_meta, "checkpoint_meta", "disaggregated",
    WT_OPEN_CONFIG_ARG_STR},
  {WT_OPEN_CONF_disaggregated_drain_threads, "drain_threads", "disaggregated",
    WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_disaggregated_last_materialized_lsn, "last_materialized_lsn", "disaggregated",
    WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_disaggregated_local_files_action, "local_files_action", "disaggregated",
    WT_OPEN_CONFIG_ARG_STR},
  {WT_OPEN_CONF_disaggregated_lose_all_my_data, "lose_all_my_data", "disaggregated",
    WT_OPEN_CONFIG_ARG_BOOL},
  ...
  {WT_OPEN_CONF_heuristic_controls_checkpoint_cleanup_obsolete_tw_pages_dirty_max,
    "checkpoint_cleanup_obsolete_tw_pages_dirty_max", "heuristic_controls", WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_heuristic_controls_eviction_obsolete_tw_pages_dirty_max,
    "eviction_obsolete_tw_pages_dirty_max", "heuristic_controls", WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_heuristic_controls_obsolete_tw_btree_max, "obsolete_tw_btree_max",
    "heuristic_controls", WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_multiprocess, "multiprocess", NULL, WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_operation_tracking_enabled, "enabled", "operation_tracking",
    WT_OPEN_CONFIG_ARG_BOOL},
  ...
  {WT_OPEN_CONF_page_delta_internal_page_delta, "internal_page_delta", "page_delta",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_page_delta_leaf_page_delta, "leaf_page_delta", "page_delta",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_page_delta_max_consecutive_delta, "max_consecutive_delta", "page_delta",
    WT_OPEN_CONFIG_ARG_INT},
  ...
  {WT_OPEN_CONF_rollback_to_stable_threads, "threads", "rollback_to_stable",
    WT_OPEN_CONFIG_ARG_INT},
  ...
  {WT_OPEN_CONF_disaggregated_local_mode, "local_mode", "disaggregated", WT_OPEN_CONFIG_ARG_BOOL},
  /* ==========================================================================
  ...
  {WT_OPEN_CONF_eviction_evict_sample_inmem, "evict_sample_inmem", "eviction",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_eviction_evict_use_softptr, "evict_use_softptr", "eviction",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_eviction_legacy_page_visit_strategy, "legacy_page_visit_strategy", "eviction",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_eviction_app_eviction_min_cache_fill_ratio, "app_eviction_min_cache_fill_ratio",
    "eviction", WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_eviction_cache_tolerance_for_app_eviction, "cache_tolerance_for_app_eviction",
    "eviction", WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_eviction_incremental_app_eviction, "incremental_app_eviction", "eviction",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_eviction_prefer_scrub_eviction, "prefer_scrub_eviction", "eviction",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_eviction_skip_update_obsolete_check, "skip_update_obsolete_check", "eviction",
    WT_OPEN_CONFIG_ARG_BOOL},
  /* ==========================================================================
  ...
  {WT_OPEN_CONF_checkpoint_cleanup_file_wait_ms, "file_wait_ms", "checkpoint_cleanup",
    WT_OPEN_CONFIG_ARG_INT},
  /* ==========================================================================
   ...
   * ========================================================================== */
  {WT_OPEN_CONF_file_manager_close_idle_time, "close_idle_time", "file_manager",
    WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_file_manager_close_scan_interval, "close_scan_interval", "file_manager",
    WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_file_manager_close_handle_minimum, "close_handle_minimum", "file_manager",
    WT_OPEN_CONFIG_ARG_INT},
  /* ==========================================================================
   * Debug Mode options (1600-1699)
   * ========================================================================== */
  {WT_OPEN_CONF_debug_mode_corruption_abort, "corruption_abort", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  ...
  {WT_OPEN_CONF_debug_mode_checkpoint_retention, "checkpoint_retention", "debug_mode",
    WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_debug_mode_configuration, "configuration", "debug_mode", WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_background_compact, "background_compact", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_crash_point_colgroup, "crash_point_colgroup", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_cursor_reposition, "cursor_reposition", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_disagg_address_cookie_upgrade, "disagg_address_cookie_upgrade",
    "debug_mode", WT_OPEN_CONFIG_ARG_STR},
  {WT_OPEN_CONF_debug_mode_disagg_address_cookie_optional_field,
    "disagg_address_cookie_optional_field", "debug_mode", WT_OPEN_CONFIG_ARG_BOOL},
  ...
  {WT_OPEN_CONF_debug_mode_slow_checkpoint, "slow_checkpoint", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_stress_skiplist, "stress_skiplist", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_tiered_flush_error_continue, "tiered_flush_error_continue", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_update_restore_evict, "update_restore_evict", "debug_mode",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_debug_mode_eviction_checkpoint_ts_ordering, "eviction_checkpoint_ts_ordering",
    "debug_mode", WT_OPEN_CONFIG_ARG_BOOL},
  /* ==========================================================================
  ...
  {WT_OPEN_CONF_chunk_cache_chunk_cache_evict_trigger, "chunk_cache_evict_trigger", "chunk_cache",
    WT_OPEN_CONFIG_ARG_INT},
  ...
  {WT_OPEN_CONF_chunk_cache_flushed_data_cache_insertion, "flushed_data_cache_insertion",
    "chunk_cache", WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_chunk_cache_type, "type", "chunk_cache", WT_OPEN_CONFIG_ARG_STR},
  /* ==========================================================================
   * Tiered options (2200-2299)
   * ========================================================================== */
  {WT_OPEN_CONF_tiered_storage_local_retention, "local_retention", "tiered_storage",
    WT_OPEN_CONFIG_ARG_INT},
  ...
  {WT_OPEN_CONF_tiered_storage_bucket_prefix, "bucket_prefix", "tiered_storage",
    WT_OPEN_CONFIG_ARG_STR},
  {WT_OPEN_CONF_tiered_storage_cache_directory, "cache_directory", "tiered_storage",
    WT_OPEN_CONFIG_ARG_STR},
   ...
   * ========================================================================== */
  {WT_OPEN_CONF_block_cache_cache_on_checkpoint, "cache_on_checkpoint", "block_cache",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_block_cache_cache_on_writes, "cache_on_writes", "block_cache",
    WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_block_cache_enabled, "enabled", "block_cache", WT_OPEN_CONFIG_ARG_BOOL},
  {WT_OPEN_CONF_block_cache_blkcache_eviction_aggression, "blkcache_eviction_aggression",
    "block_cache", WT_OPEN_CONFIG_ARG_INT},
  ...
  {WT_OPEN_CONF_block_cache_max_percent_overhead, "max_percent_overhead", "block_cache",
    WT_OPEN_CONFIG_ARG_INT},
  {WT_OPEN_CONF_block_cache_nvram_path, "nvram_path", "block_cache", WT_OPEN_CONFIG_ARG_STR},
  {WT_OPEN_CONF_block_cache_percent_file_in_dram, "percent_file_in_dram", "block_cache",
    WT_OPEN_CONFIG_ARG_INT},
 ...
 *     Look up a public key ID in the mapping table. Returns NULL if not found.
 *
 * Performance: Linear scan. For ~100 keys this is negligible. The table is sorted by public_key so
 *     binary search could be added if needed, but startup config lookup is not a hot path.
 */
 ...
 */
int
__wt_open_conf_validate_args(WT_SESSION_IMPL *session, const WT_OPEN_CONFIG_ARG *args, size_t count)
{
 ...
 *     Get the key name and parent name for a given key ID. Returns WT_NOTFOUND if key is unknown.
 */
int
__wt_open_conf_get_key_info(
