...
conn_stats = [
    ...
    ConnStat('config_collapse_fast_attempts', 'fast config collapse attempts'),
    ConnStat('config_collapse_fast_fallbacks', 'fast config collapse fallbacks'),
    ConnStat('config_collapse_fast_hits', 'fast config collapse hits'),
    ConnStat('dhandle_config_rebuilds', 'data handle configuration rebuilds'),
    ConnStat('dhandle_config_reuse_attempts', 'data handle configuration reuse checks'),
    ConnStat('dhandle_config_reuse_hits', 'data handle configuration reuse hits'),
    ...
    CursorStat('cursor_open_config_fast_null', 'cursor open with NULL/empty config (fast path)'),
    CursorStat('cursor_open_config_fast_overwrite', 'cursor open with overwrite=false (fast path)'),
    CursorStat('cursor_open_config_slow', 'cursor open requiring full config parse'),
...
dsrc_stats = [
    ...
    BtreeStat('btree_conf_cache_hit', 'btree config cache hit'),
    BtreeStat('btree_conf_cache_miss', 'btree config cache miss'),
